...
# taken from: https://github.com/huggingface/transformers/blob/main/src/transformers/models/mistral/convert_mistral_weights_to_hf.py
# only change some param features(rope_theta and sliding_window)
...
def write_model(model_path, input_base_path, model_size, tokenizer_path=None, safe_serialization=True):
    ...
    base = params.get("rope_theta", 1000000.0)
